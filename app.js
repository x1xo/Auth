...
app.get('/login', (req, res) => {
  let oAuthLinks = {
    ...
    "discord": `https://discord.com/oauth2/authorize?response_type=code&client_id=${process.env.DISCORD_CLIENT_ID}&scope=identify%20guilds.join%20email&prompt=consent`,
